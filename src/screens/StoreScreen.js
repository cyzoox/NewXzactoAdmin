  ...
  return (
    <View style={{flex: 1}}>
      ...
      <View
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('StoreSales', {store: STORE})}
          style={styles.scard}>
          <Text
            style={{fontSize: 15, fontWeight: '400', color: colors.coverDark}}>
            Sales
          </Text>
          <Text
            style={{fontSize: 18, fontWeight: '700', color: colors.coverDark}}>
            {formatMoney(calculateStoreSale(), {symbol: '₱', precision: 2})}
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => navigation.navigate('Expenses', {store: STORE})}
          style={styles.scard}>
          <Text
            style={{fontSize: 15, fontWeight: '400', color: colors.coverDark}}>
            Expenses
          ...
          <Text
            style={{fontSize: 18, fontWeight: '700', color: colors.coverDark}}>
            {formatMoney(calculateStoreExpenses(), {symbol: '₱', precision: 2})}
          </Text>
        </TouchableOpacity>
      </View>
      <View
        ...
        <View>
          <View style={styles.actualCapital}>
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              <Image
                ...
                source={require('../../assets/xzacto_icons/warehouseicons/stockscap.png')}
              />
              <Text
                style={{
                  color: colors.white,
            ...
            <View style={{flexDirection: 'row', justifyContent: 'flex-end'}}>
              <Text
                ...
                {formatMoney(calculateActualTotal(), {
                  symbol: '₱',
                  precision: 2,
                })}
              </Text>
          ...
          <View style={styles.capitalStocks}>
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              <Image
                style={{height: 60, width: 60}}
                source={require('../../assets/xzacto_icons/warehouseicons/stockssrp.png')}
              />
              <Text
                style={{
                  color: colors.white,
            ...
            <View style={{flexDirection: 'row', justifyContent: 'flex-end'}}>
              <Text
                ...
                {formatMoney(calculateStocksTotal(), {
                  symbol: '₱',
                  precision: 2,
                })}
              </Text>
        ...
        <View
          ...
          <View
            ...
            <DatePicker
              ...
              confirm={date => {
                setCustomPicker2(false), setYear(date);
